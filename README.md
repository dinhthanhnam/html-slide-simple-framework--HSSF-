...
| npm publish | **Done** — `hssf-slides@0.3.0` + `@dinhthanhnam/create-hssf@0.3.0` |

## Packages

| Package | npm name | Role |
|---------|----------|------|
| Runtime | **`hssf-slides@0.3.0`** | CSS + JS |
| CLI | **`@dinhthanhnam/create-hssf@0.3.0`** (bin: `create-hssf`) | Scaffold |
...
```
https://cdn.jsdelivr.net/npm/hssf-slides@0.3.0/dist/hssf.min.css
https://cdn.jsdelivr.net/npm/hssf-slides@0.3.0/dist/hssf.min.js
```
