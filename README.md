...
| npm publish | **Done** — `hssf-slides@0.2.1` + `@dinhthanhnam/create-hssf@0.2.1` |

## Packages

| Package | npm name | Role |
|---------|----------|------|
| Runtime | **`hssf-slides@0.2.1`** | CSS + JS |
| CLI | **`@dinhthanhnam/create-hssf@0.2.1`** (bin: `create-hssf`) | Scaffold |
