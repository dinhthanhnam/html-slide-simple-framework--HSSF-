...
Rikkei Education slide deck scaffolded with [HSSF](https://www.npmjs.com/package/hssf) via `create-hssf`.

**Runtime mode:** `local` (hssf@0.1.0)
...
CSS/JS load from jsDelivr pin `hssf@0.1.0`. Needs network.
